...
def main():
  ...
  #print_grid()
  # Draw screen border
  draw_border(0,0,screenmax_x,screenmax_y,1)
  # Draw map border
  draw_border(map_placementx-1,map_placementy-1,gsize*(map_max_x)+2,gsize*(map_max_y)+2,1)
...
def clear_dngn():
  pygame.draw.rect(screen,background_color,[map_placementx,map_placementy,gsize*(map_max_x)-1,gsize*(map_max_y)-1])
...
def draw_border(x1,y1,x2,y2,w):
  pygame.draw.rect(screen,border_color,(x1,y1,x2,y2),w)
